...
const DraggableText = forwardRef<DraggableTextHandle, DraggableTextProps>(
  function DraggableText({ body, containerWidth, containerHeight, imgPanRef, imgPinchRef }, ref) {
